-- 
-- Created By: Unknown (found at 'http://awesome.naquadah.org/wiki/Document_keybindings')
-- 
-- 
-- Name:
-- 	
...
-- Purpose:
-- 	
--     Simple key binding documentation.
-- 
-- 
-- Keywords:
-- 	
    ...
    for _, key in ipairs(keys) do
        if doc[key] then
            ...
            result[group] = (result[group] or "") ..
                '<span font="Inconsolata 10" color="#ff8d00"> ' ..
...
function display()
    ...
    for group, res in pairs(strings) do
        ...
        result = result ..
            '<span font="Inconsolata 11" weight="bold" color="#ff0000">' ..
            group .. "</span>\n" .. res
    end
